    ...
    def __init__(
        ...
        self.global_transfo1 = transforms.Compose(
            [
                ...
                transforms.RandSpatialCrop(
                    roi_size=globle_min_size, random_center=True, random_size=True
                ),
        ...
        self.local_transfo = transforms.Compose(
            [
                ...
                transforms.RandSpatialCrop(
                    roi_size=local_min_size,
                    max_roi_size=local_max_size,
                    random_center=True,
                    random_size=True,
                ),
                transforms.Resize(spatial_size=final_size),
...
def loading_transforms(
    roi: Tuple[int, int, int], in_channels: int
) -> transforms.Compose:
    """
    ...
    trans = transforms.Compose(
        [
            ...
            transforms.Spacingd(
                keys=["image"], pixdim=(1.0, 1.0, 1.0), mode=3, allow_missing_keys=True
            ),
...
def mae3d_transforms(
    config: Any, mode: str = "train", reshape: bool = False
) -> transforms.Compose:
    """
