#!/bin/bash
#SBATCH --job-name=preproc_test
#SBATCH --output=logs/preproc_test_%A_%a.out
#SBATCH --error=logs/preproc_test_%A_%a.err
#SBATCH --array=0-4  # 5 chunks for test
#SBATCH --time=4:00:00
...
echo "Processing test set chunk ${SLURM_ARRAY_TASK_ID}/${TOTAL_CHUNKS}..."
